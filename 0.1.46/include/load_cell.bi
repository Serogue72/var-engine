...
sub INIT_CHUNK()
  ...
  for I = 0 to 19
    for J = 0 to 11
      ...
      if CHUNK_TILE( 4 ).TILE( I, J ).REF then line CHUNK( 4 ).LAYER( 0 ), ( I * 16, J * 16 )-( I * 16 + 15, J * 16 + 15 ), rgb( rnd * 63, rnd * 127 + 127, rnd * 63 ), bf
      if CHUNK_TILE( 5 ).TILE( I, J ).REF then line CHUNK( 5 ).LAYER( 0 ), ( I * 16, J * 16 )-( I * 16 + 15, J * 16 + 15 ), rgb( rnd * 127 + 127, rnd * 63, rnd * 63 ), bf
      if CHUNK_TILE( 6 ).TILE( I, J ).REF then line CHUNK( 6 ).LAYER( 0 ), ( I * 16, J * 16 )-( I * 16 + 15, J * 16 + 15 ), rgb( rnd * 63, rnd * 63, rnd * 127 + 127 ), bf
    next J
  next I
