...
type udt_CHARACTER
  ...
  V_VEL as single
  SPRITE_PTR as udt_IMAGE ptr
  SPRITE_FRAME as byte
  SPRITE_FRAME_CTR as byte
  SPRITE_IS_LEFT as boolean
end type
...
type udt_DISPLAY
  ...
  SCREENRES_FLAG as integer
  DESKTOP_RESOLUTION( 0 to 1 ) as integer
  RESOLUTION_LIST( 1 to 12, 0 to 1 ) as integer
  W as long
  H as long
  CURSOR_X as long
  CURSOR_Y as long
